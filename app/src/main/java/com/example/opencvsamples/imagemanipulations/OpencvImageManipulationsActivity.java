package com.example.opencvsamples.imagemanipulations;
...
public class OpencvImageManipulationsActivity extends CameraActivity implements CvCameraViewListener2 {
    ...
    public OpencvImageManipulationsActivity() {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_opencv_image_manipulations);
    ...
    public Mat onCameraFrame(CvCameraViewFrame inputFrame) {
        ...
        switch (OpencvImageManipulationsActivity.viewMode) {
            case OpencvImageManipulationsActivity.VIEW_MODE_RGBA:
                break;

            case OpencvImageManipulationsActivity.VIEW_MODE_HIST:
                Mat hist = new Mat();
            ...
            case OpencvImageManipulationsActivity.VIEW_MODE_CANNY:
            ...
            case OpencvImageManipulationsActivity.VIEW_MODE_SOBEL:
            ...
            case OpencvImageManipulationsActivity.VIEW_MODE_SEPIA:
                rgbaInnerWindow = rgba.submat(top, top + height, left, left + width);
                Core.transform(rgbaInnerWindow, rgbaInnerWindow, mSepiaKernel);
                rgbaInnerWindow.release();
                break;

            case OpencvImageManipulationsActivity.VIEW_MODE_ZOOM:
            ...
            case OpencvImageManipulationsActivity.VIEW_MODE_PIXELIZE:
                rgbaInnerWindow = rgba.submat(top, top + height, left, left + width);
            ...
            case OpencvImageManipulationsActivity.VIEW_MODE_POSTERIZE:
            /*
