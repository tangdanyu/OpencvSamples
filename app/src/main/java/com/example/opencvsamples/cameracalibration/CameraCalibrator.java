...
public class CameraCalibrator {
    ...
    private final Size mPatternSize = new Size(4, 7);
    ...
    public void calibrate() {
        ...
        MyLogUtil.e(TAG,  String.format("Average re-projection error: %f", mRms));
        MyLogUtil.e(TAG,  "Camera matrix: " + mCameraMatrix.dump());
        MyLogUtil.e(TAG, "Distortion coefficients: " + mDistortionCoefficients.dump());
    }
