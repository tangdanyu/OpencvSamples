package com.example.opencvsamples.tutorial3;
...
public class OpencvTutorial3CameracontrolActivity extends CameraActivity implements CvCameraViewListener2, OnTouchListener {
        ...
        public void onManagerConnected(int status) {
            switch (status) {
                case LoaderCallbackInterface.SUCCESS: {
                    ...
                    mOpenCvCameraView.setOnTouchListener(OpencvTutorial3CameracontrolActivity.this);
                }
                break;
                default: {
    ...
    public OpencvTutorial3CameracontrolActivity() {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_opencv_tutorial3_cameracontrol);
