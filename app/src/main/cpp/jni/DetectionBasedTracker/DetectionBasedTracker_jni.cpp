...
JNIEXPORT void JNICALL FD_JNI_METHOD(nativeDestroyObject)
...
JNIEXPORT void JNICALL FD_JNI_METHOD(nativeStart)
(JNIEnv * jenv, jclass, jlong thiz)
{
...
JNIEXPORT void JNICALL FD_JNI_METHOD(nativeStop)
(JNIEnv * jenv, jclass, jlong thiz)
{
...
JNIEXPORT void JNICALL FD_JNI_METHOD(nativeSetFaceSize)
...
JNIEXPORT void JNICALL FD_JNI_METHOD(nativeDetect)
